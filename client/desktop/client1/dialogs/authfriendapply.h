#ifndef AUTHFRIENDAPPLY_H
#define AUTHFRIENDAPPLY_H

#include "core/global.h"
#include "widgets/clicklabel.h"
#include "widgets/clickbutton.h"
#include "core/userdata.h"
#include "friendlabel.h"

namespace Ui {
class AuthFriendApply;
}

class AuthFriendApply : public QDialog
{
    Q_OBJECT

public:
    explicit AuthFriendApply(QWidget *parent = nullptr);
    ~AuthFriendApply();
