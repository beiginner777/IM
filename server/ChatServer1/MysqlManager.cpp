...
int MysqlManager::getUserFriendApply(int uid, std::vector<std::shared_ptr<ApplyInfo>>& applyList)
{
	return dao_.getUserFriendApply(uid, applyList);
}

int MysqlManager::getUserFriendList(int uid, std::vector<std::shared_ptr<UserInfo>>& friendList)
{
	return dao_.getUserFriendList(uid, friendList);
}
...
std::shared_ptr<UserInfo> MysqlManager::getUserByName(std::string name)
{
...
int MysqlManager::GetUserThreadInfos(int uid, int last_thread_id, int page_size,std::vector<std::shared_ptr<ChatThreadInfo>>& infos, bool& load_more, int& max_thread_id)
{
	return dao_.GetUserThreadInfos(uid, last_thread_id, page_size, infos, load_more, max_thread_id);
}
...
int MysqlManager::getUserFriendListByLastId(int uid, int last_friend_id, std::map<int, std::shared_ptr<UserInfo>>& friend_list)
{
	return dao_.getUserFriendListByLastId( uid, last_friend_id, friend_list);
}

int MysqlManager::getUserFriendApplyByLastId(int uid, int last_friend_id, int page_size, std::vector<std::shared_ptr<ApplyInfo>>& applyList, bool& load_more, int& max_friend_apply_id)
{
	return dao_.getUserFriendApplyByLastId(uid,last_friend_id, page_size, applyList,load_more,max_friend_apply_id);
}
...
int MysqlManager::loadChatMessage(int thread_id, int& min_message_id, int& max_message_id, int page_size, bool& is_more, std::vector<ChatMessage>& msgs)
{
	return dao_.loadChatMessage(thread_id, min_message_id, max_message_id, page_size, is_more, msgs);
}
