...
#define FILEUPLOADFREFIX "file_upload_"
#define FILEDOWNLOADFREFIX "file_download_"
#define LOGICWORKER_COUNT 4 
#define FILEWORKER_COUNT 4
#define DOWNLOADWORKER_COUNT 4
...
#define FILEINFOEXISTTIME 3600 // 文件上传信息在 redis 中的过期时间，单位秒
#define DOWNLOADFILEEXISTTIME 7200 // 文件下载信息在 redis 中的过期时间，单位秒
#define MAX_FILE_LEN 2048 // 文件下载/上传时，每次传输的最大字节数，单位 B
...
enum ERROE_CODR
{
	...
	ERROR_UPDATE_HEAD_ICON, // 保存用户头像url到数据库时，出现错误
...
enum REQUEST_ID
{
    ...
    ID_RESUME_UPLOAD_REQ,
    ID_RESUME_UPLOAD_RSP,
	ID_REGISTER_REQ,
	ID_REGISTER_RSP
};
enum REDIS_ID
